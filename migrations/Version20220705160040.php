 ...
 */
final class Version20220705160040 extends AbstractMigration
{
	...
	public function up(Schema $schema): void
	{
		...
		$this->addSql('ALTER TABLE post CHANGE statut status TINYINT(1) DEFAULT NULL');
	}
	...
	public function down(Schema $schema): void
	{
		...
		$this->addSql('ALTER TABLE post CHANGE status statut TINYINT(1) DEFAULT NULL');
	}
}
